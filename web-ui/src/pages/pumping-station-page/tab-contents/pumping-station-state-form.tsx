...
let dxPumpingStationStateFormScrollOffset = null;
...
useEffect( () => {
    console.log(dxPumpingStationStateFormRef);
    console.log(dxPumpingStationStateFormScrollOffset);
    if (dxPumpingStationStateFormRef && dxPumpingStationStateFormRef.current && dxPumpingStationStateFormScrollOffset)
    {
        debugger;
        (dxPumpingStationStateFormRef.current.instance as any)._scrollable.scrollTo(dxPumpingStationStateFormScrollOffset)
    }
...
return (pumpingStationObjectState ?
    <Form
        ...
        onContentReady={ (e: ContentReadyEvent) => {
            (e.component.instance() as any)
            ._scrollable
            .option('onScroll',  (e: ScrollEvent) => {
                // console.log(e);
                dxPumpingStationStateFormScrollOffset = e.scrollOffset;
            });
        } }
