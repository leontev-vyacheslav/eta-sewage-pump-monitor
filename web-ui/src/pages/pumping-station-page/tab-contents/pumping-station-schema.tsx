...
export const PumpingStationSchema = () => {
    ...
    const startStopPumpsHandler = useCallback(() => {
        ...
        pumpBladesGroupNumber.forEach(i => {
            ...
            if (pumpingStationObjectState[`statePump${i}`]) {
                changeHighlightStroke(blades, '#fff');
    ...
    const levelSensorsHandler = useCallback(() => {
        ...
        Object.entries({
            ...
            if (pumpingStationObjectState[k]) {
                setDumpWaterHeigh(v);
            }
        });
    }, [pumpingStationObjectState]);
    ...
    }, [levelSensorsHandler, startStopPumpsHandler]);
    ...
    return (
        pumpingStationObjectState ?
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 379 638.04" height="600">
                ...
                <rect id="dump-water" x="80.25" y="555.04" width="218.65" height="46.01" fill="#808285" filter="url(#i)" />
